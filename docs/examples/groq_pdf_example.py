...
parser = VisionParser(
    ...
    enable_image_summary=False,  # Set to True to include image summaries, False to disable
)

# Convert PDF to markdown
pdf_path = "/Users/rushabhsmacbook/Desktop/vision-parse/embedded-images-tables.pdf"  # local path to your pdf file
